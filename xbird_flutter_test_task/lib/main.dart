...
import 'file:///D:/flutter_apps/xbird_flutter_test_task/xbird_flutter_test_task/lib/blocs/agerange/age_range_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      ...
      providers: [
        ...
        BlocProvider<AgeRangeBloc>(create: (context) => AgeRangeBloc(),)
      ],
    )
    ;
  }
